...
The aggregate country-year model returns no significant association, which is
consistent with origin-side push factors adding noise that the aggregate
design cannot absorb. The preferred bilateral specification absorbs those
origin-year pressures and controls for policy changes targeted specifically at
skilled/high-skilled and low-skilled workers. It supports the compositional
prediction: larger cumulative net restrictive policy change for
all-migrant-worker reforms is associated with a higher skill ratio among
employment-related permits (beta = 0.005446, p = 0.004, N = 6,301;
wild-cluster bootstrap p = 0.027). The estimate is essentially unchanged when
the previous year's permit denominator replaces the current-year estimation
weight. The corresponding PPML estimate for the absolute high-skilled permit
count is also positive and statistically significant (beta = 0.036814, p =
0.012), while the total employment-permit count shows no significant change.
Restricting the policy measure to work-visa and work-permit reforms gives a
larger estimate (beta = 0.006642, p = 0.0025). This pattern is consistent with
dual-track migration systems shaping who continues to enter when general
labor-migration rules become more or less restrictive, but it does not
identify the causal effect of any dedicated high-skill route.
...
beta = 0.001273 with cluster-robust SE = 0.002050 (t = 0.62, p = 0.540, N =
308, G = 30). The annual policy-flow estimate is also not significant (beta =
0.000459, SE = 0.002472, p = 0.854), and neither is the aggregate log
high-skilled-count outcome (beta = 0.020727, SE = 0.026339, p = 0.438). The
...
The preferred weighted coefficient is beta = 0.005446 with cluster-robust SE =
0.001716 (t = 3.17, p = 0.004, N = 6,301 origin-destination-year cells across
G = 30 destinations). The wild-cluster bootstrap p-value is 0.027, so the
...
is associated with a 0.54-percentage-point increase in HSRate, conditional on
...
controls are themselves imprecisely estimated: beta = 0.001721 (p = 0.425) for
skilled/high-skilled policy and beta = -0.005586 (p = 0.148) for low-skilled
policy.
...
to a 1.63-percentage-point higher HSRate the following year. A Major reform
contributes four units, corresponding to 2.18 percentage points. Relative to
the bilateral-sample mean HSRate of 20.9 percent, the Major-reform calculation
is about 10.4 percent of the mean. The comparable full-control aggregate
coefficient is smaller and imprecise (beta = 0.001273, p = 0.540); its
four-unit calculation is about 0.51 percentage points and is not statistically
distinguishable from zero.

The alternative bilateral models clarify which design choices matter. The
unweighted controlled estimate remains positive (beta = 0.003933, SE =
0.001755, p = 0.033), but its wild-cluster bootstrap p-value is 0.079. After
...
0.004351, SE = 0.001624, p = 0.012; bootstrap p = 0.013), so the
...
(beta = -0.000107, p = 0.957). The preferred finding is therefore a cumulative
...
associated with the high-skilled share (beta = 0.005446, p = 0.004, N = 6,301;
bootstrap p = 0.027), consistent with the prediction in Section 3. The
...
coefficient; the residual employment-permit estimate is negative but
imprecise; the following year's policy flow is insignificant; and
excluding 2020 strengthens the baseline estimates. However, the category
models use different samples, and the preferred share estimate becomes
small and insignificant when destination-specific trends are added.
...
in Table~ef{tab:robustness}. Panel A modifies the preferred
...
the no-cutoff, all-first-permits, no-UK ILOSTAT, work-visa-only,
prior-year-weight, and EU-directive-window checks. The origin-income estimates
are heterogeneous, the core-tool narrowing is imprecise, the aggregate placebo
coefficients are not significant, and five-percent precision is not fully
robust to omitting Spain.
...
Bilateral: prior-year denominator weights & Replaces the current-year precision weight with the previous year's employment-permit denominator & 0.005787*** & 0.001 & Significant; bootstrap p = 0.005 \\
Bilateral: leave-one-destination-out & Re-estimates the preferred model omitting each of the 30 destinations in turn & 0.0038 to 0.0063 & See text & Positive in all runs; $p<0.05$ in 29 of 30 \\
\addlinespace[3pt]
...
remains positive and significant (beta = 0.000856, p = 0.008, N = 5,392). The
corridor-FE variant is also significant (beta = 0.000897, p = 0.047), as is
the version retaining the original employment-permit scale control (beta =
0.000941, p = 0.004, N = 6,301).
...
denominator-weighted bilateral model is re-estimated on N = 6,301 cells and G
...
The work-visa-only coefficient is beta = 0.006642 with cluster-robust SE =
0.002006 (t = 3.31, p = 0.0025), moderately larger than the all-tools estimate
of 0.005446. This is consistent with the proposed mechanism because the
...
A single combined applicable-window indicator gives beta = 0.005637 with SE =
0.001766 (p = 0.003). Adding the four directive indicators separately gives
beta = 0.005606 with SE = 0.001722 (p = 0.003). Both estimates are close to
the preferred coefficient of 0.005446, and none of the directive indicators is
...
essentially unchanged and slightly more precise (beta = 0.005787, SE =
0.001638, p = 0.001; wild-cluster bootstrap p = 0.005, N = 6,229). Same-period
...
turn. The coefficient remains positive in all 30 runs, ranging from 0.0038 to
0.0063, and remains significant at five percent in 29. The exception is Spain,
one of the panel's largest permit destinations: omitting it gives beta =
0.004375 with p = 0.078. No single destination drives the sign, but
five-percent precision depends partly on the Spanish corridors.
...
no-cutoff, prior-year-weight, and all-first-permits checks remain significant.
...
prior-year-weight, and EU-directive-window checks. It is not significant in
the aggregate or bilateral annual-flow models, the UK-inclusive ILOSTAT model,
the destination-trend model, or the Spain-excluded influence check. The
...
Leave-one-destination-out estimates remain positive, but omitting Spain raises
the p-value to 0.078. Destination-specific linear trends reduce the
coefficient to near zero (beta = 0.001283, p = 0.482). Because the cumulative
...
PPML: highly-skilled-worker permits (EMP\_HSW)
  & 0.044605 & 0.019434 & 0.033 ** & 5,108 & 21 \\
PPML: researcher permits (EMP\_RSE)
  & 0.021252 & 0.031067 & 0.500 n.s. & 5,395 & 25 \\
PPML: EU Blue Card permits (EMP\_BLUE)
  & -0.047367 & 0.041114 & 0.262 n.s. & 4,204 & 23 \\
Weighted OLS with future policy flow: lagged cumulative score
  & 0.006497 & 0.001615 & 0.0004 *** & 5,570 & 30 \\
Weighted OLS with future policy flow: policy flow at $t+1$
  & -0.000810 & 0.000991 & 0.420 n.s. & 5,570 & 30 \\
Weighted OLS, 2008--2019 sample
  & 0.006516 & 0.001612 & 0.0004 *** & 5,608 & 30 \\
PPML: high-skilled permit count, 2008--2019
  & 0.045536 & 0.012895 & 0.002 *** & 5,219 & 27 \\
PPML: residual employment-permit count, 2008--2019
  & -0.029493 & 0.018175 & 0.115 n.s. & 5,607 & 30 \\
Weighted OLS with destination-specific linear trends
  & 0.001283 & 0.001803 & 0.482 n.s. & 6,301 & 30 \\
\end{longtable}
